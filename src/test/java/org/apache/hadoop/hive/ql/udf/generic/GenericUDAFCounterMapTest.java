...
public class GenericUDAFCounterMapTest extends HiveTestServiceWithConstants {
  
  public GenericUDAFCounterMapTest() throws IOException {
    super();
  }
  ...
  public void testSimple() throws Exception {
    ...
    client.execute(String.format(CREATE_FUNCTION_f, GenericUDAFCounterMap.class.getName()));
